...
mvn install:install-file -Dfile=simplecaptcha-20060705.jar -DgroupId=net.sf.simplecaptcha -DartifactId=simplecaptcha -Dversion=20060705-SNAPSHOT -Dpackaging=jar -DgeneratePom=true
