...
public class LogicInterfaceProxyTest implements LogicInterface {
	...
	@Override
	public int createClipboardItems(final List<Post<? extends org.bibsonomy.model.Resource>> posts) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public int deleteClipboardItems(final List<Post<? extends org.bibsonomy.model.Resource>> posts, final boolean clearClipboard) {
		return 0;
	}
