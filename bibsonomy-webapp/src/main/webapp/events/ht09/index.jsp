 ...
 font-size: 80%;
  ...
  <div id="full">
    ...
    <div class="explanation">
      ...
      The publication metadata are <a href="/export/user/ht09">available in many formats</a>, including  <a href="${urlGenerator.getPublicationsAsBibtexUrlByUserName('ht09')}">BibTeX</a> and  <a href="/burst/user/ht09">RDF</a>.
    </div>
