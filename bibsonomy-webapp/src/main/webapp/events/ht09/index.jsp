...
<%-------------------------- Heading -----------------------%>
<h1><a href="/" rel="Start">BibSonomy</a> :: Hypertext 2009
 ...
 font-size: 80%;
  ...
  <div id="full">
    ...
    <div class="explanation">
      ...
      The publication metadata are <a href="${relativeUrlGenerator.prefix('export/').getUserUrlByUserName('ht09')}">available in many formats</a>, including  <a href="${relativeUrlGenerator.getPublicationsAsBibtexUrlByUserName('ht09')}">BibTeX</a> and  <a href="/burst/user/ht09">RDF</a>.
    </div>
