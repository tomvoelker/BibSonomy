var LocalizedStrings = { 
   ...
   "buttons.shortcut_bookmalayout.expand.bookmarksrks_end" : "Whenever you are on an interesting webpage, you just click on this button. You are asked to type in some tags, and the bookmark is automatically added to your library. Then you can continue your navigation.",
   ...
   "database.exception.systemTag.forFriend.notFriend" : "send:{0}: {0} only receives posts from his friends and you are not listed as a friend of {0}.",
   "database.exception.systemTag.forFriend.self" : "send:{0}: You can not send posts to yourself.",
   "database.exception.systemTag.forGroup.member" : "for:{0}: You are not a member of {0}. Only members can forward posts to a group.",
   "database.exception.systemTag.forGroup.noSuchGroup" : "for:{0}: {0} does not exist.",
   "database.exception.systemTag.forGroup.specialGroup" : "for:{0}: {0} is a special group. You are not allowed to forward posts to special groups.",
   ...
   "database.exceptions.missing.groups" : "There are no groups for this post.",
   "database.exceptions.missing.resource" : "This post is missing a resource.",
   "days" : "days",
   ...
   "error.parse.bibtex.failed" : "Error parsing BibTeX:\r\n\r\n{0}\r\n\r\nMessage was: \r\n\r\n{1}",
   ...
   "import.error.erroneous_line_numbers" : "Your submitted publications contain errors at the lines with the following numbers:",
   "import.error.parse_or_incomplete_bibtex" : "Parsed BibTeXes",
   "import.error.parse_or_incomplete_bibtex.description" : "The following BibTeXes were extracted from your file. Erroneous entries are marked as such and <strong>CANNOT</strong> be saved. The given line numbers of your document mark the spots, where BibSonomy failed to extract the publication information. You can fix these errors and upload your file again, or you might be interested in saving the successfully parsed entries and enter the rest manually.",
   ...
   "inboxPage.about" : "When a friend tags one of his posts with \"send:{0}\", it will be send to your inbox. For details see <a href",
   "last" : "&gt;&gt;",
   ...
   "navi.password.ldap" : "ldap password",
   "navi.pdfs" : "PDFs",
   ...
   "navi.username.ldap" : "ldap username",
   ...
   "post.resource.editBookmark" : "Feel free to edit your bookmark post",
   "post.resource.editPublication" : "Feel free to edit your publication post",
   ...
   "post.resource.hint1" : "For further information (and users of IE) look <a href",
   ...
   "post_bibtex.doi_isbn.description" : "Here you can enter the ISBN or DOI of a publication.",
   ...
   "post_bibtex.manual.description" : "Please enter title, year and author/editor on this form to check, if you've already bookmarked this publication. On the next page you can enter the remaining publication metadata fields.",
   "post_bibtex.manual.heading" : "Enter your publication data here:",
   "post_bibtex.manual.title" : "manual",
   "post_bibtex.pub_snippet.description" : "Just copy and paste any valid BibTeX snippet or publication reference into this box and enter a description. If your snippet contains only one BibTeX entry you can edit it on the next page.",
   ...
   "puma.button.collect.description" : "en:Sammeln Sie auf Webseiten, durch eine komfortable unterst\u00FCtzende Eingabe oder \u00FCber Importm\u00F6glichkeiten Publikationen und Lesezeichen",
   "puma.button.organize.description" : "en:Nutzen sie einfache Stichw\u00F6rter, um Ihre Eintr\u00E4ge jederzeit leicht zu finden.",
   "puma.button.share.description" : "en:Senden Sie Ihre Publikationen an KOBRA oder das FIS oder teilen Sie sie mit anderen Benutzern",
   "puma.system.about" : "{0} is a system for sharing lists of literature and bookmarks. When discovering a publication or a bookmark on the web, you can store it by just one click on our server. You can add tags to your post to retrieve it more easily. This is very similar to the bookmarks/favorites that you store within your browser. The main advantages of {0} are ... is that you can access your data from  whereever you are. Furthermore, you can discover more bookmarks and publications from your friends and other people.",
   "puma.system.desc" : "Academic publication management to collect and share publications",
   "puma.system.introduction" : "puma.system.introduction",
   ...
   "settings.confirm" : "Ask for confirmation when deleting posts.",
