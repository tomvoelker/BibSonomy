var LocalizedStrings = { 
   ...
   "import.edit_before_import.help" : "If this is checked, the imports wont be saved directly. You will have the opportunity to edit the publications before adding them.",
   "import.failed" : "failed",
   "import.firefox" : "Firefox",
   "import.formerly_imported" : "old",
   "import.kind" : "Which kind of data do you want to import?",
   "import.newResources" : "successfully created {0} {1}:",
   "import.newly_imported" : "newly imported",
   ...
   "import.overwrite2" : "The {0} bookmarks overwrite the {1} ones.",
   ...
   "plain" : "plain",
   "post" : "post",
   "post.edit.existent" : "Note: You are editing an existing post.",
   "post.meta.add" : "add",
   ...
   "scraper_info.link_header" : "All supported sites",
   "scraper_info.scraper_detail_pre" : "The details of the single scrapers will be explained in the following.",
   "scraper_info.scraper_details_header" : "Scraper Details",
   "scraper_info.scraper_help_link" : "/help/scraper",
   "scraper_info.scraper_link_description" : "The following list contains all supported portals whose contained publications can be extracted for you with the \"Post Bookmark\"-Button. The links make a good starting point for importing bibtexes your documents of interests into Bibsonomy.",
