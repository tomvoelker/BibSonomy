var LocalizedStrings = { 
   ...
   "database.exception.systemTag.forFriend.notFriend" : "invalid tag \"send:{0}\": {0} only receives posts from his friends and you are not listed as a friend of {0}.",
   "database.exception.systemTag.forFriend.self" : "invalid tag \"send:{0}\": You can not send posts to yourself.",
   "database.exception.systemTag.forGroup.member" : "invalid tag \"for:{0}\": You are not a member of {0}. Only members can forward posts to a group.",
   "database.exception.systemTag.forGroup.noSuchGroup" : "invalid tag \"for:{0}\": {0} does not exist.",
   "database.exception.systemTag.forGroup.specialGroup" : "invalid tag \"for:{0}\": {0} is a special group. You are not allowed to forward posts to special groups.",
   ...
   "edittags.main.note" : "NOTE: Replacing tags in relations only works, when exactly one tag is replaced by one other tag.",
   ...
   "navi.password.ldap" : "library password",
   "navi.pdfs" : "PDFs",
   ...
   "navi.username.ldap" : "library username",
   ...
   "register.ldap.hint2" : "register using your library account.",
