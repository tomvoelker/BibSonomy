var LocalizedStrings = { 
   "-error.scrape.nothing" : "Automatic metadata extraction is currently not supported for the URL {0}.",
   "Show" : "Show",
   ...
   "actions.remoteauth.conferator" : "The Conferator system uses {0} for authorization purposes. By clicking on the link \"Yes, grant authorization\" below, you can pass the necessary authorization token to Conferator; one Conferator receives this token, you will be logged in. The transport of the authorization token is secured, and no other system than Conferator can use this token.",
   "actions.remoteauth.do_you_trust" : "Please decide if you grant authorization to this page. IMPORTANT: Please grant authorization only to pages you trust!",
   "actions.remoteauth.no" : "No, don't grant authorization.",
   "actions.remoteauth.page_requesting" : "The following page requests is requesting authorization:\u0009",
   "actions.remoteauth.title" : "Remote Authorization",
   "actions.remoteauth.validity" : "Please note: The authorization grant is issued for the IP address {0} and is valid for {1} minutes.",
   "actions.remoteauth.yes" : "Yes, grant authorization.",
   ...
   "basket.info" : "Here you can manage publication posts you picked with the \"pick\" link. For details see <a href",
   ...
   "bibtex.actions.additionalFiles" : "Add additional files.",
   ...
   "bibtex.actions.filedeleted" : "File {0} deleted.",
   ...
   "cv.hint2" : "personal data and the picture you have entered in your <a href",
   ...
   "cv.own_bookmarks" : "Own Bookmarks",
   ...
   "error.activation_code_expired" : "Your activation code has expired. You can <a href",
   ...
   "error.upload.failed.filetype" : "Please check your file. Only {0} files are accepted.",
   ...
   "events.error.registered" : "You are already registered.",
   "events.error.registration" : "An unknown error occured. The error message is {0}.",
   "events.registration.address" : "Billing Address",
   "events.registration.generalInformation" : "Registration information",
   "events.registration.participantDetails.facebook" : "You should enter your Facebook account name here.",
   "events.registration.participantDetails.linkedIn" : "You should enter your public profile data here (\"Settings\" -> \"Public Profile\")",
   "events.registration.participantDetails.researchGate" : "You should enter your \"My public page address\" here (\"Settings -> Privacy Settings -> Public Page\").",
   "events.registration.participantDetails.twitter" : "You should enter your twitter name here.",
   "events.registration.participantDetails.xing" : "You should enter the URL of your Xing profile here.",
   "events.registration.profile" : "You should set this to 'public' such that other participants can see the data. Your profile is then also visible for everbody in BibSonomy.",
   "events.registration.profileData" : "{0} profile data",
   "events.registration.registered" : "Register",
   "events.registration.registered.badgeName" : "Name on Badge",
   "events.registration.registered.badgeTitle" : "Title on Badge",
   "events.registration.registered.badgeinstitutionname" : "Institution on Badge",
   "events.registration.registered.confirm" : "(binding registration, I will pay the fee of EUR 10)",
   "events.registration.registered.dinner" : "workshop dinner",
   "events.registration.registered.dinner.explanation" : "I will participate at the workshop dinner (<a href",
   "events.registration.registered.poster" : "I will bring a poster.",
   "events.registration.registered.poster.explanation" : "For enabling more discussion, we encourage posters in general.",
   "events.registration.registered.presenter" : "I am a presenter.",
   "events.registration.registered.presenter.explanation" : "(Please click if you are presenting a paper.)",
   "events.registration.registered.socialEvent" : "social event",
   "events.registration.registered.socialEvent.explanation" : "I want to participate in a free guided city tour.",
   "events.registration.registered.success.furtherInfo" : "Hier finden Sie weitere Informationen:",
   "events.registration.registered.success.message" : "Congratulations, you have successfully registered for",
   "events.registration.registered.success.registration" : "Registration successful!",
   "events.registration.registered.vegetarian" : "vegetarian",
   "events.registration.registered.vegetarian.explanation" : "I prefer vegetarian food.",
   "events.registration.socialInformation" : "Social Systems Information",
   "events.registration.subEvent" : "Track",
   "events.registration.welcome" : "You are logged in as user {0} in {1}. Welcome to {2}.",
   ...
   "importPublicationHints.postBibtexButton" : "As a shortcut for posting publication entries we introduced the following bookmarklet  <buttons:postPublication/>. For installation, please read <a href",
   "importPublicationHints.postBibtexButton.alternative1" : "Select/highlight a publication entry on a web page",
   "importPublicationHints.postBibtexButton.alternative2" : "Use it on specific publication pages (like ACM, CiteSeer, SpringerLink, etc.) where our scrapers extract the entries automatically. Follow this <a href",
   "importPublicationHints.postBibtexPage" : "Importing your BibTeX files is as easy as using the upload form on the <a href",
   "importPublicationHints.postBibtexSnippet" : "If you want to copy and paste one or more BibTeX snippets, please use the snippet box on the <a href",
   "inbox.actions.removeAllMessages" : "clear inbox",
   "inbox.actions.removeAllMessages.title" : "remove all posts from your inbox",
   "inboxPage.about" : "When another user tags one of his posts with \"send:{0}\", it will be send to your inbox. For details see <a href",
   "last" : "&gt;&gt;",
   ...
   "login.notice.conferator" : "<h1>Welcome to the Conferator System at LWA 2010!</h1><br/><br/> <p>The login into the conferator system for LWA 2010 works via BibSonomy; please log in first here, then you'll be directed back to Conferator.</p>",
   "login.notice.events" : "<h1>Welcome to the MyGroup Registration</h1><br /> <p>The registration for MyGroup works via BibSonomy.</p>",
   ...
   "login.notice.welcome_5" : "Afterwards, please <a href",
   ...
   "meta.lang" : "en",
   "mobile.switch" : "Switch to normal website",
   "more" : "more",
   "myGroup" : "myGroup",
   ...
   "navi.editGoldStandardPublication" : "edit gold standard post",
   ...
   "post.actions.delete.gold.title" : "delete this gold standard post",
   "post.actions.delete.title" : "delete this post from your repository",
   "post.actions.edit" : "edit",
   "post.actions.edit.gold.title" : "edit this gold standard post",
   "post.actions.edit.title" : "edit this post",
   "post.bibtex.addedFiles" : "Added files:",
   "post.bibtex.delete" : "delete",
   "post.bibtex.fileExists" : "File already exists.",
   "post.bibtex.files" : "Files",
   "post.bibtex.help" : "The newly added files are stored temporarily. After Click on \"save\", they are added to the publication.",
   "post.bibtex.uploadedFiles" : "Earlier uploaded files",
   ...
   "post.resource.bibtexKey.help" : "a memorable key without spaces",
   ...
   "post.resource.booktitle.help" : "title of a book when only a part is cited",
   ...
   "post.resource.crossref.help" : "The BibTeX key this work is referring to.",
   ...
   "post.resource.description.help" : "A short description or comment",
   "post.resource.editBookmark" : "edit your bookmark post",
   "post.resource.editGoldStandardPublication" : "Edit this gold standard post",
   ...
   "post.resource.editor.help" : "each editor on a separate line, format \"Firstname Lastname\"",
   "post.resource.entrytype" : "entry type",
   "post.resource.entrytype.help" : "the type of the publication",
   ...
   "post.resource.hint1" : "For further information (and if you are user of the IE browser) have a look <a href",
   "post.resource.howpublished" : "howpublished",
   "post.resource.howpublished.help" : "anything unusual about the method of publishing, e.g. \"privately published\"",
   "post.resource.institution" : "institution",
   "post.resource.institution.help" : "name of the sponsoring institution for a technical report",
   "post.resource.journal" : "journal",
   "post.resource.journal.help" : "full (unabbreviated) journal title",
   "post.resource.key" : "key",
   "post.resource.key.help" : "used by BibTeX for sorting entries without author or editor",
   "post.resource.misc" : "misc fields",
   "post.resource.misc.help" : "this field can be used to import non-standard fields in addition to the predefined ones. Please use BibTeX compliant syntax, e.g. <tt>fieldName",
   "post.resource.month" : "month",
   "post.resource.month.help" : "the month of publication",
   "post.resource.myown" : "I am an author",
   "post.resource.myown.help" : "If you are one of the authors of this publication you can add the system tag \"myown\" with this checkbox.",
   "post.resource.notagset" : "Currently there are no tagsets available for this group.",
   "post.resource.note" : "note",
   "post.resource.note.help" : "additional information which could help the reader",
   "post.resource.number" : "number",
   "post.resource.number.help" : "number of journal, magazine, technical report, or work in a series",
   "post.resource.openaccess.additionalfields.additionaltitle" : "additional title",
   "post.resource.openaccess.additionalfields.additionaltitle.help" : "additional title",
   "post.resource.openaccess.additionalfields.institution" : "institution and fachbereich",
   "post.resource.openaccess.additionalfields.institution.help" : "Institution and fachbereich. format:<br/>city, name of university, FB short, FB long<br/>\ne.g. Kassel, Universit\u00E4t, FB 16, Elektrotechnik/Informatik",
   "post.resource.openaccess.additionalfields.phdoralexam" : "oral examination day",
   "post.resource.openaccess.additionalfields.phdoralexam.help" : "oral examination day",
   "post.resource.openaccess.additionalfields.referee" : "referee",
   "post.resource.openaccess.additionalfields.referee.help" : "referee. format: surename, first name (Title)",
   "post.resource.openaccess.additionalfields.sponsor" : "sponsors",
   "post.resource.openaccess.additionalfields.sponsor.help" : "sponsors",
   ...
   "post.resource.openaccess.headline" : "Instutional Repository",
   "post.resource.openaccess.headline.additionalfields" : "additional metadata for repository",
   "post.resource.openaccess.headline.classification" : "Classifications",
   "post.resource.openaccess.headline.sherparomeo" : "publisher's conditions",
   "post.resource.openaccess.noinfoavailable" : "no information available",
   ...
   "post.resource.type.help" : "type of technical report, e.g. \"research report\"",
   ...
   "ranking.tfidf" : "tfidf",
   "register.acceptPrivacy" : "I accept the <a href",
   "register.activate" : "To complete your registration please click the link in your registration mail within the next 24 hours. <br/><br/>If the activation link , you can repeat the registration process with the same user name.",
   ...
   "scraper_info.scraper_detail_pre" : "The details of each scraper will be explained in the following. For more information, have a look at the <a href",
   "scraper_info.scraper_details_header" : "Scraper Details",
   "scraper_info.scraper_help_link" : "/help/Scraper",
   "scraper_info.scraper_link_description" : "The following list contains all supported portals whose publications can be extracted for you with the <a href",
   ...
   "settings.group.login" : "Sorry, you're not logged in with the corresponding group account. Please login as group <a href",
   ...
   "settings.picture.header" : "a picture for my <a href",
   ...
   "settings.profileInfo" : "The information you enter here will be displayed on your <a href",
   ...
   "tagrelations.title" : "visit your {0} page",
