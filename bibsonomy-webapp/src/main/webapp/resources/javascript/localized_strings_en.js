var LocalizedStrings = { 
   ...
   "system.groups" : "If you want a group added to the system, create a user account \\",
   ...
   "export.info" : "By clicking on one of the formats you can export the publications of the page {0} in that format.",
   "export.bibtex.faq" : "{0} is a very popular bibliography management tool for {1}. Save this output and include it in your LaTeX	file with the command {2} by substituting {3} with the name you gave the file while saving it and omitting the {4} ending.",
   "export.rtf.faq" : "This exports the publication list in {0} which can be used by word processors like {1} or {2}. It is formatted according to the Harvard bibliography style guidelines.",
   "export.html.faq" : "This gives you a simple {0} formatted page which you can include into your homepage.",
   "export.rss.faq" : "With an appropriate {0}-tool you can subscribe to this RSS feed and get notifications when someone adds publications to it.",
   "export.simplehtml.faq" : "A HTML layout without any header or footer but very nice output. This is useful for integrating publication lists into other HTML pages.",
   "export.tablerefs.faq" : "A more structured HTML output with each entry as a row in a table and additional JavaScript search function.",
   "export.tablerefsbib.faq" : "Similar to TableRefs but additionally includes the BibTeX source and the abstract of the publication.",
   "export.tablerefsbibsort.faq" : "Similar to TableRefsAbsBib, but includes possibility to sort the table by each column.",
   "export.docbook.faq" : "This is an {0} output according to the {1} schema.",
   "export.endnote.faq" : "This is an output in {0} which is used by EndNote, another bibliography management tool.",
   "export.openoffice.faq" : "CSV, or Comma Separated Values divides all fields of the entry by a comma. It is useful to import the publications into spreadsheet programs.",
   "export.dblp.faq" : "DBLP export your records to a DBLP conformable XML structure.",
   "export.text.faq" : "This is another {0} output.",
   "export.jucs.faq" : "Output formatted according to the guidelines of the {0}.",
   ...
   "bibtex.upload.file.page" : "File upload",
   "bibtex.upload.file.link" : "Upload file",
   ...
   "post.resource.suggested" : "suggested",
   ...
   "post.resource.select" : "please select",
   ...
   "tagrelations.show.itemspercount" : "Currenty showing {0} items per page.",
   "tagrelations.show.itemspercount.count" : "Show {0}, {1}, {2}, {3} items per page.",
   ...
   "error.field.valid.title" : "Please enter a valid title.",
   ...
   "errors.post.notfound" : "The post with the given intra hash could not be found.",
