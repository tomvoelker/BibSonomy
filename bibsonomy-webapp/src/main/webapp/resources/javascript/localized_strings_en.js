var LocalizedStrings = { 
   ...
   "reminder.helptext" : "If you have lost you're password you can request a new one with this formular. You will receive an email with the automatically generated password which you use to login the next time.",
   ...
   "post.resource.spaceseperated" : "space seperated",
   ...
   "post.meta.unpick.title" : "remove all publication posts from this page to your basket",
   ...
   "error.field.valid.url" : "Bitte geben Sie eine valide URL ein (Anmerkung: Urls beginnen meist mit http://www. ...)",
   "error.field.valid.title" : "please enter a valid title",
   "error.field.valid.tags" : "please enter valid tags",
   "error.field.valid.url.alreadybookmarked" : "url already bookmarked",
