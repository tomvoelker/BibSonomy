var LocalizedStrings = { 
   ...
   "error.activation_code_expired" : "Your activation code has expired.",
   ...
   "error.field.oneResourceMin" : "You had to have at least one resource to show",
   ...
   "post.edit.spam_note" : "The captcha is shown only to users who have been flagged by our automatic spam classification system. Normally, those users post advertisements or illegal content.\nUnfortunately from time to time, one of our regular users is accidentally flagged.\nPlease inform us, if you feel that you have been misclassified. Just send an e-mail\nto  <a href",
   "post.meta.add" : "add",
   ...
   "register.activate" : "To complete your registration please click the link in your registration mail within the next 24 hours.",
