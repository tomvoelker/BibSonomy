...
function pumainit(){
	...
	// add surrounding div .sidebarboxinner to #sidebar
	$("#sidebar").wrap('<div class="sidebarBoxInner" id="sidebarboxinnerAroundSidebar" />');

	// add surrounding div with class="sidebarBoxOuter" id="sidebox" to #sidebarboxinnerAroundSidebar
	$("#sidebarboxinnerAroundSidebar").wrap('<div class="sidebarBoxOuter" id="sidebox" />');
	
	// add help box as sidebox to sidebar
