...
function pumainit(){
	...
	$("#sidebarroundcorner").prepend('<div class="sidebarBoxOuter" id="helpbox"><div class="sidebarBoxInner"><div id="helpboxcontent" class="boxcontent"><div id="togglehelp" class="togglehelp closeX">x</div><div class="bc-head">Hilfe</div>Ausführliche Informationen erhalten sie in der <a href="http://puma.uni-kassel.de/help_de">Hilfe</a> und im <a href="http://blog.puma.uni-kassel.de/">PUMA-Blog</a>..</div></div></div>');
	$('img#sidebarGrip').remove();
	$('div#helpbox').before('<img id="sidebarGrip" border="0" src="/resources/image/grip.png" alt="a gripper"/>');
