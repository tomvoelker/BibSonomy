...
public class DBLPConstantsHandler extends DefaultHandler{
	 ...
	 * result object
	 */
	private DBLPConstantsResult conResult;
	...
	public void setConResult(DBLPConstantsResult conResult) {
    ...
    public void startElement (String uri, String name, String qName, Attributes atts){
    	if(name.equals(XML_ELEMENT_CONSTANTS) && !dbconstants){
    		conResult = new DBLPConstantsResult();//found constants
