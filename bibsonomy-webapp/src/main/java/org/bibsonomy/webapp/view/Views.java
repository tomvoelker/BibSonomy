...
public enum Views implements View {
	...
	/**
	 * friend page shows all posts which are set viewable for friends of the
	 * requested user
	 */
	FRIENDPAGE("friend"),
	...
	/**
	 * viewable page showing all resources of a specified group and a given tag
	 * or list of tags
	 */
	...
	/**
	 * the author tag showing all resources of a specified author and a given
	 * tag or list of tags
	 */
	...
	/**
	 * where users can register TODO: we will probably move those action parts
	...
	/**
	 * and "bib" against the URL path. Decide carefully, which one you use! (I
	 * would call this a FIXME, but we can neither change the path nor the
