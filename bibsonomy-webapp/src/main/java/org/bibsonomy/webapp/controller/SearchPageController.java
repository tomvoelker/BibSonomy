	...
	public View workOn(final SearchViewCommand command) {
		try {
			...
			for (final Class<? extends Resource> resourceType : this.getListsToInitialize(command)) {
				...
				this.setList(command, resourceType, groupingEntity, groupingName, requestedTags, null, search, queryScope, null, command.getOrder(), command.getStartDate(), command.getEndDate(), command
