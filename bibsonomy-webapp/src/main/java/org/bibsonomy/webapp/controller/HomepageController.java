...
public class HomepageController extends SingleResourceListController implements MinimalisticController<HomepageCommand> {
	...
	public View workOn(final HomepageCommand command) {
		...
		if ("html".equals(format)) {
			 ...
			 */
			command.setNews(this.logic.getPosts(Bookmark.class, GroupingEntity.GROUP, newsGroup, Arrays.asList(newsTag), null, null, QueryScope.LOCAL, null, SortKey.NONE, null, null, 0, 3));
			this.endTiming();
