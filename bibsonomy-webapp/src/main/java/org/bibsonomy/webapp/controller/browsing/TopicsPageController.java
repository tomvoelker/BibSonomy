 ...
 * @version $Id$
 */
public class TopicsPageController extends SingleResourceListControllerWithTags implements MinimalisticController<ClusterSettingsCommand> {
