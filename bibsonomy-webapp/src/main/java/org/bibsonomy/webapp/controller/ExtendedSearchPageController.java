...
/**
 * Controller for extended search page
 *
 */
public class ExtendedSearchPageController extends SingleResourceListController implements MinimalisticController<ExtendedSearchViewCommand>, ErrorAware {

	private static final Log log = LogFactory.getLog(ExtendedSearchPageController.class);
	...
	@Override
	public View workOn(ExtendedSearchViewCommand command) {
		try {
	...
	@Override
	public ExtendedSearchViewCommand instantiateCommand() {
		final ExtendedSearchViewCommand command = new ExtendedSearchViewCommand();
