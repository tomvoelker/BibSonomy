...
public class TagPageController extends MultiResourceListController implements MinimalisticController<TagResourceViewCommand>{
	...
	public View workOn(final TagResourceViewCommand command) {
		...
		if (command.getFormat().equals("html")) {
			this.setRelatedTags(command, Resource.class, GroupingEntity.ALL, null, null, requTags, 0, 20);
	...
	protected <T extends Resource, V extends TagResourceViewCommand> void setRelatedTags(V cmd, Class<T> resourceType, GroupingEntity groupingEntity, String groupingName, String regex, List<String> tags, int start, int end) {
