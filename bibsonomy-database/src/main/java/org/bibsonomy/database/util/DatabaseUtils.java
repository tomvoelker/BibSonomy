...
public class DatabaseUtils {
	 ...
	 */
	public static void setGroups(final DatabaseManager db, final GenericParam<? extends Resource> param) {
	 ...
	 */
	public static void prepareGetPostForGroup(final DatabaseManager db, final GenericParam<? extends Resource> param) {
	 ...
	 */
	public static void prepareGetPostForUser(final DatabaseManager db, final GenericParam<? extends Resource> param) {
