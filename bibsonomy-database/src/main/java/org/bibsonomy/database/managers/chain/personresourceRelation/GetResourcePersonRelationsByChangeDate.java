...
public class GetResourcePersonRelationsByChangeDate extends ResourcePersonRelationChainElement {
     ...
     */
    public GetResourcePersonRelationsByChangeDate(PersonDatabaseManager personDatabaseManager) {
