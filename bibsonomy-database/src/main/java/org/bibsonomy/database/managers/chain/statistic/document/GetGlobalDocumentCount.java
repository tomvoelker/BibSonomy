 ...
 * @author dzo
 */
public class GetGlobalDocumentCount extends StatisticChainElement {
	...
	protected boolean canHandle(StatisticsParam param) {
		return GroupingEntity.ALL.equals(param.getGrouping()) && !present(param.getFilter());
	}
	
	@Override
	protected Statistics handle(StatisticsParam param, DBSession session) {
		return new Statistics(this.db.getNumberOfDocuments(session));
	}
}
