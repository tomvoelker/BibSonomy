...
public class BibTexChain implements FirstChainElement<Post<BibTex>, BibTexParam> {
	 ...
	 */
	public BibTexChain() {
		this.getBibTexByHash = new GetResourcesByHash<BibTex, BibTexParam>();
		this.getBibTexByHashForUser = new GetResourcesByHashForUser<BibTex, BibTexParam>();
		this.getBibTexByTagNames = new GetResourcesByTagNames<BibTex, BibTexParam>();
		...
		this.getBibTexForHomePage = new GetResourcesForHomepage<BibTex, BibTexParam>();
		...
		this.getBibTexByFriends = new GetResourcesByFriends<BibTex, BibTexParam>();	
		...
		this.getBibTexViewable.setNext(this.getPublicationsByConceptForUser);
		this.getPublicationsByConceptForUser.setNext(this.getBibTexByUserFriends);
		...
		this.getBibTexByFriends.setNext(this.getPublicationsByFollowedUsers);
		this.getPublicationsByFollowedUsers.setNext(this.getBibTexByResourceSearch);
		this.getBibTexByResourceSearch.setNext(this.getBibTexByConceptByTag);
		this.getBibTexByConceptByTag.setNext(this.getPublicationsByConceptForGroup);
		this.getPublicationsByConceptForGroup.setNext(this.getBibTexByKey);
