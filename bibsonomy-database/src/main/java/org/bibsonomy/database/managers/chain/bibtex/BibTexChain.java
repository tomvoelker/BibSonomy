...
public class BibTexChain implements FirstChainElement<Post<BibTex>, BibTexParam> {
	...
	private final ChainElement<Post<BibTex>, BibTexParam> getResourcesFromInbox;
	...
	public BibTexChain() {
		...
		this.getResourcesFromInbox = new GetBibTexFromInbox<BibTex, BibTexParam>();
		...
		this.getBibTexFromBasketForUser.setNext(this.getResourcesFromInbox);
	}
