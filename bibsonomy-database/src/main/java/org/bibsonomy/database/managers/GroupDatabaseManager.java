...
public class GroupDatabaseManager extends AbstractDatabaseManager {
	 ...
	 * @param paramGroup
	 */
	public void updateGroupLevelPermissions(final User loginUser, final Group group, final DBSession session) {
		try {
			session.beginTransaction();
	...
	protected Group getGroupWithGroupLevelPermissions(Group group, final DBSession session) {
