...
public class GetGoldStandardsByResourceSearch<RR extends Resource, R extends Resource & GoldStandard<RR>, P extends ResourceParam<RR>> extends GoldStandardChainElement<RR, R, P> {
	...
	protected List<Post<R>> handle(final P param, final DBSession session) {
		...
		return search.getPosts(param.getResourceType(),param.getUserName(), param.getRequestedUserName(), param.getRequestedGroupName(), null, param.getGroupNames(), param.getSearchType(),param.getSearch(), param.getTitle(), param.getAuthor(), null, null, null, null, null, param.getOrder(), param.getLimit(), param.getOffset());
	}
