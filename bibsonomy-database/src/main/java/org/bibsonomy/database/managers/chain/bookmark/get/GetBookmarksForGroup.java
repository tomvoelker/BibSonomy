...
public class GetBookmarksForGroup extends BookmarkChainElement {
	...
	protected List<Post<Bookmark>> handle(final BookmarkParam param, final DBSession session) {
		...
		return this.db.getPostsForGroup(groupId, param.getGroups(), param.getUserName(), HashID.getSimHash(param.getSimHash()), null, param.getLimit(), param.getOffset(), null, session);
	}
