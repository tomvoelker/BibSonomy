...
public class GetResourcesByTagNames<R extends Resource, P extends ResourceParam<R>> extends ResourceChainElement<R, P> {
	...
	protected List<Post<R>> handle(final P param, final DBSession session) {
		return this.databaseManager.getPostsByTagNames(GroupID.PUBLIC.getId(), param.getTagIndex(), param.getQueryScope(), param.getOrder(), param.getLimit(), param.getOffset(), session);
	}
