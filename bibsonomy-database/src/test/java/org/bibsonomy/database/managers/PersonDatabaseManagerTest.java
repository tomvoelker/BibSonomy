...
public class PersonDatabaseManagerTest extends AbstractDatabaseManagerTest {
	...
	public void testRemoveResourceRelation() {
		final List<ResourcePersonRelation> resourcePersonRelationsWithPosts = PERSON_DATABASE_MANAGER.getResourcePersonRelationsWithPosts(PERSON_ID, loginUser, this.dbSession);
		...
		final List<ResourcePersonRelation> afterDeletion = PERSON_DATABASE_MANAGER.getResourcePersonRelationsWithPosts(PERSON_ID, loginUser, this.dbSession);
	...
	public void testMergePersons() {
		...
		final List<ResourcePersonRelation> relations = PERSON_DATABASE_MANAGER.getResourcePersonRelationsWithPosts(personMergeTarget.getPersonId(), loginUser, this.dbSession);
