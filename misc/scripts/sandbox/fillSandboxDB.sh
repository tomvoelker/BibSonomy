...
/usr/bin/java -cp .:./bibsonomy-internal-tools-2.0.48-SNAPSHOT-executable.jar org.bibsonomy.lucene.util.LuceneIndexGenerator 1 publication bookmark goldStandardPublication
