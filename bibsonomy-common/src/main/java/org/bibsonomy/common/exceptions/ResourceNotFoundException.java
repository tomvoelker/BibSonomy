...
public class ResourceNotFoundException extends RuntimeException {
	...
	/**
     * Constructs a new resource not found exception with the specified resource id.
     * 
     * @param   resourceId   the id of the resource that was not found. This is written into a detail message which is saved for 
