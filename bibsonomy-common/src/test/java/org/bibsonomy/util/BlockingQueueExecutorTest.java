...
//		}
		...
		Assert.assertTrue((submissionTimes[2] - submissionTimes[1]) < SLEEP_MILLIS * 1200 * 1000);
		Assert.assertTrue((submissionTimes[3] - submissionTimes[2]) > SLEEP_MILLIS * 1000 * 1000);
		Assert.assertTrue((submissionTimes[3] - submissionTimes[2]) < SLEEP_MILLIS * 1200 * 1000);
