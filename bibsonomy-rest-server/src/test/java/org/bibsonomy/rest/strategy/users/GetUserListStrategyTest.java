...
public class GetUserListStrategyTest extends AbstractContextTest {
	...
	public void testGetUserListStrategy() throws Exception {
		final Context ctx = new Context(HttpMethod.GET, "/api/users", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, this.db, new HashMap<String, String>(), null);
