...
public class ContextUserTest extends AbstractContextTest {
	...
	public void testGetListOfUsersStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.GET, "/users", new HashMap());
	...
	public void testPostUserStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.POST, "/users", new HashMap());
	...
	public void testGetDetailsOfUserStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.GET, "/users/testuser", new HashMap());
	...
	public void testPutDetailsOfUserStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.PUT, "/users/testuser", new HashMap());
	...
	public void testDeleteUserStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.DELETE, "/users/testuser", new HashMap());
	...
	public void testGetUserPostsStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.GET, "/users/testuser/posts", new HashMap());
	...
	public void testPostPostStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.POST, "/users/testuser/posts", new HashMap());
	...
	public void testGetPostDetailsStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.GET, "/users/testuser/posts/asdfsadf012312", new HashMap());
	...
	public void testPutPostStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.PUT, "/users/testuser/posts/asdfsadf012312", new HashMap());
	...
	public void testDeletePostStrategy() throws Exception {
		final Context ctx = new Context(this.is, this.db, HttpMethod.DELETE, "/users/testuser/posts/asdfsadf012312", new HashMap());
