...
public class GetUserListOfGroupStrategyTest extends AbstractContextTest {
	...
	public void testGetUserListOfGroupStrategy() throws Exception {
		final Context c = new Context(HttpMethod.GET, "/api/groups/public/users", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, this.db, null, new HashMap<>(),
				new HashMap<>(), null);
		...
		assertEquals("bibsonomy/users+XML", c.getContentType(RESTConfig.API_USER_AGENT));
	}
}