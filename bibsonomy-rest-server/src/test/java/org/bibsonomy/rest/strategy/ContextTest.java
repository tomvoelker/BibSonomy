...
public class ContextTest extends AbstractContextTest {
	...
	public void testGetSimpleTags() {
		...
		final Context ctx = new Context(HttpMethod.GET, "/api/users/egal/posts", RenderingFormat.XML.XML, new RendererFactory(this.urlRenderer), this.is, null, this.db, this.parameterMap, null);
	...
	public void testGetListOfGroupsStrategy() throws Exception {
		final Context c = new Context(HttpMethod.GET, "/api/groups", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testAddGroupStrategy() throws Exception {
		final Context c = new Context(HttpMethod.POST, "/api/groups", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testGetDetailsOfGroupStrategy() throws Exception {
		final Context c = new Context(HttpMethod.GET, "/api/groups/testgroup", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testUpdateGroupDetailsStrategy() throws Exception {
		final Context c = new Context(HttpMethod.PUT, "/api/groups/testgroup", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testDeleteGroupStrategy() throws Exception {
		final Context c = new Context(HttpMethod.DELETE, "/api/groups/testgroup", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testGetUserListOfGroupStrategy() throws Exception {
		final Context c = new Context(HttpMethod.GET, "/api/groups/testgroup/users", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testAddUserToGroupStrategy() throws Exception {
		final Context c = new Context(HttpMethod.POST, "/api/groups/testgroup/users", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(),
				null);
	...
	public void testGetListOfTagsStrategy() throws Exception {
		final Context c = new Context(HttpMethod.GET, "/api/tags", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testGetTagDetailsStrategy() throws Exception {
		final Context c = new Context(HttpMethod.GET, "/api/tags/wichtig", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testGetListOfUsersStrategy() throws Exception {
		final Context ctx = new Context(HttpMethod.GET, "/api/users", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, this.db, new HashMap<Object, Object>(), null);
	...
	public void testPostUserStrategy() throws Exception {
		final Context ctx = new Context(HttpMethod.POST, "/api/users", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, this.db, new HashMap<Object, Object>(), null);
	...
	public void testGetDetailsOfUserStrategy() throws Exception {
		final Context ctx = new Context(HttpMethod.GET, "/api/users/testuser", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, this.db, new HashMap<Object, Object>(), null);
	...
	public void testPutDetailsOfUserStrategy() throws Exception {
		final Context ctx = new Context(HttpMethod.PUT, "/api/users/testuser", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, this.db, new HashMap<Object, Object>(), null);
	...
	public void testDeleteUserStrategy() throws Exception {
		final Context ctx = new Context(HttpMethod.DELETE, "/api/users/testuser", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, this.db, new HashMap<Object, Object>(),
				null);
	...
	public void testGetUserPostsStrategy() throws Exception {
		final Context ctx = new Context(HttpMethod.GET, "/api/users/testuser/posts", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, this.db, new HashMap<Object, Object>(),
				null);
	...
	public void testGetListOfPostsStrategy() throws Exception {
		final Context c = new Context(HttpMethod.GET, "/api/posts", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testGetNewPostsStrategy() throws Exception {
		final Context c = new Context(HttpMethod.GET, "/api/posts/added", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testGetPopularPostsStrategy() throws Exception {
		final Context c = new Context(HttpMethod.GET, "/api/posts/popular", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, db, new HashMap<Object, Object>(), null);
	...
	public void testWrongUsage() {
		try {
			new Context(HttpMethod.GET, null, RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, null, Collections.EMPTY_MAP, null);
			fail("Should throw exception");
		} catch (final AccessDeniedException ex) {
		}

		try {
			new Context(HttpMethod.GET, "", RenderingFormat.XML, new RendererFactory(this.urlRenderer), this.is, null, null, null, null);
			fail("Should throw exception");
