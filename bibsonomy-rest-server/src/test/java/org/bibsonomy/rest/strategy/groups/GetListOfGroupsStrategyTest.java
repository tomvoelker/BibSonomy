...
public class GetListOfGroupsStrategyTest extends AbstractContextTest {
	 ...
	 */
	@Test
	public void testGetListOfGroupsStrategy() throws InternServerException, NoSuchResourceException, ResourceNotFoundException, ResourceMovedException {
		final Context ctx = new Context(this.is, this.db, HttpMethod.GET, "/groups", new HashMap<String, String>(), null, null);
