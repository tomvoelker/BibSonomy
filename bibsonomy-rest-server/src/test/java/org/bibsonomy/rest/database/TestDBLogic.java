...
public class TestDBLogic implements LogicInterface {
	 ...
	 */
	public List<Tag> getTags(Class<? extends Resource> resourceType, GroupingEntity grouping, String groupingName, String regex, List<String> tags_, int start, int end) {
