...
public class GetNewPostsStrategy extends AbstractListOfPostsStrategy {
	...
	protected List<? extends Post<? extends Resource>> getList() {
		return this.getLogic().getPosts(resourceType, grouping, groupingValue, this.tags, null, Order.ADDED, this.getView().getStartValue(), this.getView().getEndValue(), search);
	}
}