...
/**
 * Strategy to update organization details.
 *
 * @author kchoong
 */
public class UpdateOrganizationDetailsStrategy extends AbstractUpdateStrategy {
	 ...
	 * @param orgName
	 */
	public UpdateOrganizationDetailsStrategy(final Context context, final String orgName) {
		super(context);
	...
	protected String update() throws InternServerException {
		...
		group.setName(this.orgName);
		// ensure organization flag
