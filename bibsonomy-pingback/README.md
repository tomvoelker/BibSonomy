...
The BibSonomy Pingback allows to notify webpages about posted publications via
...
* Please see the file [LICENSE.txt](https://bitbucket.org/bibsonomy/bibsonomy/src/tip/bibsonomy-pingback/LICENSE.txt?at=stable)
