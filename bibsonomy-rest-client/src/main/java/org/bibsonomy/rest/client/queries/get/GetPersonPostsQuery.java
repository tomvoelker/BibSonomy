 ...
 * @author dzo
 */
public class GetPersonPostsQuery extends AbstractQuery<List<Post<? extends Resource>>> {
    ...
    public GetPersonPostsQuery(ResourcePersonRelationQuery query) {
        if (!present(query)) {
    ...
    protected void doExecute() throws ErrorPerformingRequestException {
        UrlBuilder urlBuilder = this.getUrlRenderer().createUrlBuilderForPersonPosts(this.personId);
