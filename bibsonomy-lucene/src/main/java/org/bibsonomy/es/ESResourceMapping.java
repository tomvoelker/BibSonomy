...
public class ESResourceMapping {
	...
	private static XContentBuilder createMappingForPublication(final String documentType) throws IOException {
		final XContentBuilder mapping = jsonBuilder().startObject().startObject(documentType).startObject("properties").startObject("address").field("type", "string").field("index", "no").endObject().startObject("annote").field("type", "string").field("index", "no").endObject().startObject("bKey").field("type", "string").field("index", "no").endObject().startObject("bibtexAbstract").field("type", "string").field("index", "no").endObject().startObject("booktitle").field("type", "string").field("index", "no").endObject().startObject("chapter").field("type", "string").field("index", "no").endObject().startObject("crossref").field("type", "string").field("index", "no").endObject().startObject("day").field("type", "string").field("index", "no").endObject().startObject("edition").field("type", "string").field("index", "no").endObject().startObject("editor").field("type", "string").field("index", "no")
