# BibSonomy Marc Parser

## What is it?

The BibSonomy Marc Parser allows to parse MARC bibliographic data.
...
* Please see the file [LICENSE.txt](https://bitbucket.org/bibsonomy/bibsonomy/src/tip/bibsonomy-marc-parser/LICENSE.txt?at=stable)
