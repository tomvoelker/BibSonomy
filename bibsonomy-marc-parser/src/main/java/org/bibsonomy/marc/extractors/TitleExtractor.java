 ...
 * 002@ 2.Position a -> einbändiges werk (book)
 * 002@ 2.Position a  -> teil eines mehrbändigen W. (book)
 * 	f -> gesamtname (036c $a) + ": " + teilname=normalname (021a $a)
 *  F -> nur teiltitel (021a $a)
 * 
 * mvbook für gesammte sammlungen
 * book für einzelne bücher aus der sammlung
 * 
 * 002@
 * 	b (Zeitschrift) -> periodical
 * 		021a als titel
 * 		029A oder F
 * 		033A
 * 		031@  $a (marc 362 a) (wichtig)
 *	o (Aufsatz) ->?
 *	
 * series extractor:
 * 
 ...
 * 
 * PICA Format
 * lok: <...> <ILN (library number)>
 * 
 * exp: (exemplare)?
 *
 * 
 * 013H $0 u -> phdthesis (oder ggf book wenn publisher 33A $n vorhanden ist? - zu heikel)
 *   037C $a ins note feld)
 *   
 *   
 * 013H/0X = k-> proceedings
 *   dann (nein immer) marc 111 oder 110 als organization und nicht als autor
 * 
 * organisation
 * 029A/0X
 * 029A/0X
 ...
 * 	pica 029A $a <$c>    sonst 029F $8 <$g>          sonst 029E $8 <$g> / $b    marc 710 genauso 
 * 
