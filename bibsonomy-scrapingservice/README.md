# BibSonomy Scrapingservice

## What is it?

The BibSonomy Scrapingservice allows to extract bibliographic metadata from 
web pages into BibTeX format. 
...
* Please see the file [LICENSE.txt](https://bitbucket.org/bibsonomy/bibsonomy/src/tip/bibsonomy-scrapingservice/LICENSE.txt?at=stable)
