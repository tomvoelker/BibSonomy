...
We're using Apache Mina's FtpServer project:
...
- Browsers:
    - Firefox 3.0.x
	- Safari and IE don't apply

- OSs:
	- MacOS X (10.5.x) "Connect to server"
	- Windows 2000 "Map Network drive"



3. WebDAV implementation

Borrowed implementation from Confluence' WebDAV Plugin:

	http://confluence.atlassian.com/display/CONFEXT/WebDAV+Plugin

Since a new version of the plugin uses JackRabbit we may have a look at
their SimpleWebdavServlet here:

	http://jackrabbit.apache.org/jackrabbit-web-application.html


3.1 Compatible WebDAV clients
