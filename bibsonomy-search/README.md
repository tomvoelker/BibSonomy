...
BibSonomy Search contains helper classes which are used through
all search modules of BibSonomy.
...
* Please see the file [LICENSE.txt](https://bitbucket.org/bibsonomy/bibsonomy/src/tip/bibsonomy-search/LICENSE.txt?at=stable)
