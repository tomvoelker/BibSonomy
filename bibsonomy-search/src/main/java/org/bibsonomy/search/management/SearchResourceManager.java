 ...
 */
public class SearchResourceManager<R extends Resource> implements GenerateIndexCallback<R>, UpdatePlugin {
	private static final Log log = LogFactory.getLog(SearchResourceManager.class);
	...
	private AbstractIndexGenerator<R> generator;
...
//		return null;
//		// TODO return this.activeIndex.isIndexEnabled() ? this.activeIndex.getStatistics() : null;
//	}
//
//	/**
