 ...
 * @version $Id$
 */
public class GetUserListOfGroupStrategyTest extends TestCase
{
   public void testGetUserListOfGroupStrategy()
   {
      Context c = new Context( new TestDatabase(), HttpMethod.GET, "/groups/public/users", new HashMap<String,String>() );
      ...
      // renderer test
      assertEquals(  690, response.getStringWriter().toString().length() );
