...
BibSonomy Wiki contains the classes for the user/group cv wikis.
...
* Please see the file [LICENSE.txt](https://bitbucket.org/bibsonomy/bibsonomy/src/tip/bibsonomy-wiki/LICENSE.txt?at=stable)
