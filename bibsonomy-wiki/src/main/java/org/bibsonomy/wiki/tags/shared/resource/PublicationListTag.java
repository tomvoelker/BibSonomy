...
public class PublicationListTag extends SharedTag {
	...
	protected String renderSharedTag() {
		 ...
		 */
		List<Post<BibTex>> posts = this.logic.getPosts(BibTex.class, this.getGroupingEntity(), requestedName, Arrays.asList(tags.split(" ")), null, null,SearchType.LUCENESEARCH, null, null, null, null, 0, PostLogicInterface.MAX_QUERY_SIZE);
