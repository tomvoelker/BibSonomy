# BibSonomy Entity Resolver

## What is it?

BibSonomy Entity Resolver contains helper classes to resolve entities.
...
* Please see the file [LICENSE.txt](https://bitbucket.org/bibsonomy/bibsonomy/src/tip/bibsonomy-entityresolver/LICENSE.txt?at=stable)
