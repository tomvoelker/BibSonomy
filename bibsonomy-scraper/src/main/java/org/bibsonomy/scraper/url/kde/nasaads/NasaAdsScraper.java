...
public class NasaAdsScraper extends AbstractUrlScraper {
	...
	private static final List<Pair<Pattern, Pattern>> patterns = Collections.singletonList(new Pair<Pattern, Pattern>(Pattern.compile(".*" + URL_NASA_ADS_HOST), AbstractUrlScraper.EMPTY_PATTERN));
