...
public class AmazonScraper extends AbstractUrlScraper {
	...
	static {
		patterns.add(new Pair<Pattern, Pattern>(Pattern.compile(".*" + AMAZON_HOST_CA), AbstractUrlScraper.EMPTY_PATTERN));
		patterns.add(new Pair<Pattern, Pattern>(Pattern.compile(".*" + AMAZON_HOST_JP), AbstractUrlScraper.EMPTY_PATTERN));
		patterns.add(new Pair<Pattern, Pattern>(Pattern.compile(".*" + AMAZON_HOST_CO_JP), AbstractUrlScraper.EMPTY_PATTERN));
		patterns.add(new Pair<Pattern, Pattern>(Pattern.compile(".*" + AMAZON_HOST_CO_UK), AbstractUrlScraper.EMPTY_PATTERN));
		patterns.add(new Pair<Pattern, Pattern>(Pattern.compile(".*" + AMAZON_HOST_COM), AbstractUrlScraper.EMPTY_PATTERN));
		patterns.add(new Pair<Pattern, Pattern>(Pattern.compile(".*" + AMAZON_HOST_DE), AbstractUrlScraper.EMPTY_PATTERN));
		patterns.add(new Pair<Pattern, Pattern>(Pattern.compile(".*" + AMAZON_HOST_FR), AbstractUrlScraper.EMPTY_PATTERN));
	}
