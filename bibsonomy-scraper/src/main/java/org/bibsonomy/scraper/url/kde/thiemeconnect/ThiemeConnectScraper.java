...
public class ThiemeConnectScraper extends GenericRISURLScraper {
	
	private static final String SITE_NAME = "Journal of Neurological Surgery Part A";
	private static final String SITE_URL = "https://www.thieme-connect.de";
	private static final String INFO = "Scraper for Journals from " + href(SITE_URL, SITE_NAME)+".";
	private static final String HOST = "thieme-connect.de";
