 ...
 */
public class UmanisticaDigitaleScraper extends GenericBibTeXURLScraper {
	...
	protected String getDownloadURL(URL url, String cookies) throws ScrapingException, IOException {
		...
		return "https://umanisticadigitale.unibo.it/citationstylelanguage/download/bibtex?submissionId=" + m_id.group(1);
	}
}