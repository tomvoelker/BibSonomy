 ...
 *
 */
public class EconstorScraper extends AbstractUrlScraper {

	private final Log log = LogFactory.getLog(EconstorScraper.class);

	private static final String SITE_NAME = "EconStor";
	private static final String SITE_URL = "http://www.econstor.eu/dspace/";
	private static final String INFO = "This scraper parses a publication page from the " + href(SITE_URL, SITE_NAME);

	private static final String BIBTEX_URL = "http://www.econstor.eu/dspace/bibtexexport/"; 

	private static final List<Pair<Pattern, Pattern>> PATTERNS = Collections.singletonList(new Pair<Pattern, Pattern>(Pattern.compile(".*" + "econstor.eu"), AbstractUrlScraper.EMPTY_PATTERN));
