 ...
 * @version $Id$
 */
public class CoinsScraper implements Scraper, UrlScraper {

	private static final String INFO = "<a herf=\"http://ocoins.info/\">COinS</a> Scraper: Scraper for Metadata in COinS format. Author: KDE";
	
	private static final String PATTERN_COINS = "<span class=\"Z3988\" title=\"([^\\\"]*)\"";
	private static final String PATTERN_KEY_VALUE = "([^=]*)=([^&]*)&?";
	...
	public boolean scrape(ScrapingContext sc)throws ScrapingException {
		if(sc != null && sc.getUrl() != null && supportsUrl(sc.getUrl())){
			...
			Pattern patternCoins = Pattern.compile(PATTERN_COINS);
			Matcher matcherCoins = patternCoins.matcher(page);
			if(matcherCoins.find()){
				...
				Matcher matcherKeyValue = patternKeyValue.matcher(titleValue);
