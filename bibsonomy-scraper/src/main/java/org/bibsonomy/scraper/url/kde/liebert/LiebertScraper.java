 ...
 * @version $Id$
 */
public class LiebertScraper implements Scraper {

	private static final String info = "Liebertonline Scraper: This Scraper parses a publication from http://www.liebertonline.com/ "+
	...
	private static final String LIEBERT_BIBTEX_PATH = "/action/showCitFormats?doi=";
	...
	public boolean scrape(ScrapingContext sc)
		...
		if (sc.getUrl() != null) {
			...
			if(url.startsWith(LIEBERT_HOST_NAME)) {
				...
				if(url.startsWith(LIEBERT_HOST_NAME + LIEBERT_BIBTEX_PATH)) {
