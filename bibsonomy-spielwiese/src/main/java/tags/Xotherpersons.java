...
/**
 * Anzahl der USer, die auch diese Ressource getaggt haben: Einfärbung des
 * Hintergrundes (v)
 * 
 * @author mgr
 */
public class Xotherpersons extends TagSupport {
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print("style=\"background-color: rgb(" + v + "%, " + v + "%, " + v + "%);\"");
