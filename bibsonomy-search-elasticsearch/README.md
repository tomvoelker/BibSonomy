# BibSonomy Search Elasticsearch

## What is it?

The BibSonomy Search Elasticsearch module provides a full text search for BibSonomy
based on [Elasticsearch](https://www.elastic.co/products/elasticsearch).
...
* Please see the file [LICENSE.txt](https://bitbucket.org/bibsonomy/bibsonomy/src/tip/bibsonomy-search-elasticsearch/LICENSE.txt?at=stable)
