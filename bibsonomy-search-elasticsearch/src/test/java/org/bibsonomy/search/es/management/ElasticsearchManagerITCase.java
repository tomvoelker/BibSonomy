...
public class ElasticsearchManagerITCase extends AbstractEsIndexTest {
	...
	public void testUpdateIndexWithSpammer() {
		...
		final ResultList<Post<BibTex>> posts = publicationSearch.getPosts(userToFlag, userToFlag, null, null, Collections.<String>emptyList(), null, null, null, null, null, null, null, null, null, null, SortKey.DATE, 10, 0, null);
		...
		final ResultList<Post<BibTex>> readded = publicationSearch.getPosts(userToFlag, userToFlag, null, null, Collections.<String>emptyList(), null, null, null, null, null, null, null, null, null, null, SortKey.DATE, 10, 0, null);
