...
public class ElasticsearchCommunityManagerBookmarkITCase extends AbstractCommunityPostSearchTest<GoldStandardBookmark> {
	...
	private static final EsResourceSearch<GoldStandardBookmark> COMMMUNITY_BOOKMARK_SEARCH = EsSpringContextWrapper.getContext().getBean("elasticsearchCommunityBookmarkSearch", EsResourceSearch.class);
	...
	public void testGenerate() {
		...
		final ResultList<Post<GoldStandardBookmark>> communityResults = COMMMUNITY_BOOKMARK_SEARCH.getPosts(null, null, null, null, null, null, "Universität Kassel", null, null, null, null, null, null, null, null, null, 10, 0);
		assertThat(communityResults.size(), is(1));

		// check if also normal posts are indexed
		final ResultList<Post<GoldStandardBookmark>> normalPosts = COMMMUNITY_BOOKMARK_SEARCH.getPosts(null, null, null, null, null, null, "KDE", null, null, null, null, null, null, null, null, null, 10, 0);
