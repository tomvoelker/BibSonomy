...
public class PublicationMappingBuilder extends ResourceMappingBuilder<BibTex> {
	...
	protected void doResourceSpecificMapping(XContentBuilder builder) throws IOException {
		builder
			...
			.endObject()
			// search fields
			.startObject(Fields.Sorting.AUTHOR)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Sorting.EDITOR)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Sorting.BOOKTITLE)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Sorting.JOURNAL)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Sorting.SERIES)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
				.field(ESConstants.NORMALIZER, ESConstants.LOWERCASE_NORMALIZER)
			.endObject()
			.startObject(Fields.Sorting.SCHOOL)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Sorting.INSTITUTION)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Sorting.ORGANIZATION)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
