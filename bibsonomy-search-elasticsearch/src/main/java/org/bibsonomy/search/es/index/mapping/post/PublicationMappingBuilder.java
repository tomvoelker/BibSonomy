...
public class PublicationMappingBuilder extends ResourceMappingBuilder<BibTex> {
	...
	protected void doResourceSpecificMapping(XContentBuilder builder) throws IOException {
		builder
			...
			.endObject()
			// search fields
			.startObject(Fields.Search.AUTHOR)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Search.EDITOR)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Search.BOOKTITLE)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Search.JOURNAL)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Search.SERIES)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
				.field(ESConstants.NORMALIZER, ESConstants.LOWERCASE_NORMALIZER)
			.endObject()
			.startObject(Fields.Search.SCHOOL)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Search.INSTITUTION)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
			.startObject(Fields.Search.ORGANIZATION)
				.field(ESConstants.IndexSettings.TYPE_FIELD, ESConstants.IndexSettings.KEYWORD_TYPE)
			.endObject()
