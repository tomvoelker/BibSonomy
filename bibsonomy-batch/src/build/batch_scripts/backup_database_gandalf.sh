...
BACKUP_DIR=/tmp/database_backup


# database specific paths
DB_DATA_DIR=$HOME/mysql-var/data               # bin-/relay-log directory
...
DB_SOCKET=$HOME/mysql-var/mysqld.sock  # MySQL socket file
DB_MYSQLDUMP=$HOME/mysql/bin/mysqldump       # location of mysqldump
DB_MYSQLADMIN=$HOME/mysql/bin/mysqladmin     # location of mysqladim
