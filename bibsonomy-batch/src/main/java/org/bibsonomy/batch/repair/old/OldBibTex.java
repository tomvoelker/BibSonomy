...
public class OldBibTex extends Resource {
	...
	private List<OldPersonName> authorList;
	private String booktitle;
	private String chapter;
	private String crossref;
	private String edition;
	private String editor;
	private List<OldPersonName> editorList;
	 ...
	 * @return authorList
	 */
	public List<OldPersonName> getAuthorList() {
		if (this.authorList == null) {
			this.authorList = OldPersonNameUtils.extractList(this.author);
		}
	 ...
	 * @return editorList
	 */
	public List<OldPersonName> getEditorList() {
		if (this.editorList == null) {
			this.editorList = OldPersonNameUtils.extractList(this.editor);
		}
	...
	public String getSimHash0() {
		return OldSimHash.getSimHash0(this);
	}
	...
	public String getSimHash1() {
		return OldSimHash.getSimHash1(this);
	}
	...
	public String getSimHash2() {
		return OldSimHash.getSimHash2(this);
	}
	...
	public void recalculateHashes() {
		this.setIntraHash(OldSimHash.getSimHash(this, HashID.INTRA_HASH));
		this.setInterHash(OldSimHash.getSimHash(this, HashID.INTER_HASH));
	}
